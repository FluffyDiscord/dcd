...
| INV-4 | TC-023, IT-005 (local flock); IT-011 (remote lease: released on SIGKILL, and on lease expiry with the channel still open), IT-011b (exclusive while heartbeating, holder named from `.meta`) |
| INV-5 | TC-019 |
| INV-6 | TC-017, TC-019 |
